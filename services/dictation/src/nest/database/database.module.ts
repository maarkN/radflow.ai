...
import { CreateOutboxTable1753200000001, OutboxModel, UnitOfWorkTypeOrm } from '@radflow/ddd';
  ...
  providers: [
    {
      ...
      useFactory: async (config: ConfigService<EnvDto, true>) => {
        const dataSource = new DataSource({
          ...
          entities: [ReportModel, OutboxModel],
          migrations: [CreateReportsTable1753300000000, CreateOutboxTable1753200000001],
          migrationsRun: true,
